"""autogenerated by genpy from clopema_moveit/ClopemaLinearInterpolationDualRequest.msg. Do not edit."""
import sys
...
class ClopemaLinearInterpolationDualRequest(genpy.Message):
  _md5sum = "930015b0a4c55fb8011e706873f22b36"
  _type = "clopema_moveit/ClopemaLinearInterpolationDualRequest"
...
"""
  __slots__ = ['header','ik_link_name_1','ik_link_name_2','poses_1','poses_2']
  _slot_types = ['std_msgs/Header','string','string','geometry_msgs/Pose[]','geometry_msgs/Pose[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,ik_link_name_1,ik_link_name_2,poses_1,poses_2
    ...
    """
    if args or kwds:
      super(ClopemaLinearInterpolationDualRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.ik_link_name_1 is None:
        self.ik_link_name_1 = ''
      if self.ik_link_name_2 is None:
        self.ik_link_name_2 = ''
      if self.poses_1 is None:
        self.poses_1 = []
      if self.poses_2 is None:
        self.poses_2 = []
    else:
      self.header = std_msgs.msg.Header()
      self.ik_link_name_1 = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.ik_link_name_1
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.ik_link_name_2
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.poses_1)
      buff.write(_struct_I.pack(length))
      for val1 in self.poses_1:
        _v1 = val1.position
        _x = _v1
      ...
      length = len(self.poses_2)
      buff.write(_struct_I.pack(length))
      for val1 in self.poses_2:
        _v3 = val1.position
        _x = _v3
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.ik_link_name_1 = str[start:end].decode('utf-8')
      else:
        self.ik_link_name_1 = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.ik_link_name_2 = str[start:end].decode('utf-8')
      else:
        self.ik_link_name_2 = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.poses_1 = []
...
"""autogenerated by genpy from clopema_moveit/ClopemaLinearInterpolationDualResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ClopemaLinearInterpolationDualResponse(genpy.Message):
  _md5sum = "081d706d7402fd088d83609cec22f23c"
  _type = "clopema_moveit/ClopemaLinearInterpolationDualResponse"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClopemaLinearInterpolationDualResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class ClopemaLinearInterpolationDual(object):
  _type          = 'clopema_moveit/ClopemaLinearInterpolationDual'
  _md5sum = 'ac3abf06f8ca55f5e5b5116592b49c59'
  _request_class  = ClopemaLinearInterpolationDualRequest
  _response_class = ClopemaLinearInterpolationDualResponse
