...
cd "/home/andrew/TeamProject/Clopema/src/clopema_testbed/clopema_robot"
...
/usr/bin/env \
    ...
    build --build-base "/home/andrew/TeamProject/Clopema/build/clopema_testbed/clopema_robot" \
    install \
    $DESTDIR_ARG \
