...
cd "/home/andrew/TeamProject/Clopema/src/clopema_testbed/clopema_calibration"
...
/usr/bin/env \
    ...
    build --build-base "/home/andrew/TeamProject/Clopema/build/clopema_testbed/clopema_calibration" \
    install \
    $DESTDIR_ARG \
